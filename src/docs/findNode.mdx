...
Once you have your Node ID, EMAIL it to us at [ckb-node-probe@cryptape.com](ckb-node-probe@cryptape.com) along with any relevant details about your router setup. The team will assit you in making your node connectable.
